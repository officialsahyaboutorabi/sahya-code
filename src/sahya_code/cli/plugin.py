...
from sahya_code.plugin import PluginError
...
def install_cmd(
    ...
    from sahya_code.plugin.manager import get_plugins_dir, install_plugin
    ...
    try:
        ...
        from sahya_code.llm import augment_provider_with_env_vars
        from sahya_code.plugin.manager import collect_host_values
...
def list_cmd() -> None:
    ...
    from sahya_code.plugin.manager import get_plugins_dir, list_plugins
...
def remove_cmd(
    ...
    from sahya_code.plugin.manager import get_plugins_dir, remove_plugin
...
def info_cmd(
    ...
    """Show plugin details."""
    from sahya_code.plugin import parse_plugin_json
    from sahya_code.plugin.manager import get_plugins_dir
