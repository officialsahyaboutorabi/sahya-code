  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all SahyaCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific SahyaCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new SahyaCode session for interacting with AI assistants and managing conversations.",
