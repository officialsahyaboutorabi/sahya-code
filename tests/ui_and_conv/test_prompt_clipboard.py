...
from sahya_code.ui.shell import prompt as shell_prompt
from sahya_code.ui.shell.prompt import PromptMode
from sahya_code.utils.clipboard import ClipboardResult
...
async def test_question_delegate_expands_placeholders_on_submit() -> None:
    ...
    from sahya_code.ui.shell.question_panel import QuestionPromptDelegate, QuestionRequestPanel
    from sahya_code.wire.types import QuestionItem, QuestionRequest
