...
from sahya_code.tools.plan import ExitPlanMode, Params, PlanOption
from sahya_code.tools.plan.enter import _DESCRIPTION, EnterPlanMode
from sahya_code.tools.plan.heroes import (
    _slug_cache,
    get_or_create_slug,
    get_plan_file_path,
    read_plan_file,
...
from sahya_code.wire.types import QuestionNotSupported, QuestionRequest, ToolCall
...
class TestKimiSoulPlanSessionPersistence:
    ...
    async def test_plan_session_id_cleared_after_deactivation(
        ...
        # Restart + re-activate
        from sahya_code.tools.plan.heroes import _slug_cache
