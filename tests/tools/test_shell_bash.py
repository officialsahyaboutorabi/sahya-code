...
from sahya_code.tools.shell import Params, Shell
from sahya_code.tools.utils import DEFAULT_MAX_CHARS
...
async def test_timeout_parameter_validation_bounds(shell_tool: Shell):
    ...
    from sahya_code.tools.shell import MAX_BACKGROUND_TIMEOUT, MAX_FOREGROUND_TIMEOUT
