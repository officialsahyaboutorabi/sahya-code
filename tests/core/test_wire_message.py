...
from sahya_code.wire.file import WireMessageRecord
from sahya_code.wire.serde import deserialize_wire_message, serialize_wire_message
...
def test_read_wire_lines_request_id(tmp_path: Path):
    ...
    from sahya_code.web.api.sessions import _read_wire_lines
