...
from sahya_code.soul import get_wire_or_none, wire_send
from sahya_code.soul.toolset import get_current_tool_call_or_none
from sahya_code.tools.utils import load_desc
from sahya_code.wire.types import QuestionItem, QuestionNotSupported, QuestionOption, QuestionRequest
...
class EnterPlanMode(CallableTool2[Params]):
    ...
    def bind(
        ...
        """Late-bind soul callbacks after SahyaSoul is constructed."""
