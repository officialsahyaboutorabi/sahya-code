...
from sahya_code.soul import StatusSnapshot, format_context_status
from sahya_code.ui.shell import placeholders as prompt_placeholders
from sahya_code.ui.shell.console import console
from sahya_code.ui.shell.placeholders import (
    PromptPlaceholderManager,
    normalize_pasted_text,
    sanitize_surrogates,
)
from sahya_code.ui.theme import get_prompt_style, get_toolbar_colors
from sahya_code.utils.clipboard import (
    grab_media_from_clipboard,
    is_clipboard_available,
)
from sahya_code.utils.logging import logger
from sahya_code.utils.slashcmd import SlashCommand
from sahya_code.wire.types import ContentPart
...
class CustomPromptSession:
    ...
    def _open_in_external_editor(self, event: KeyPressEvent) -> None:
        ...
        from sahya_code.utils.editor import edit_text_in_editor, get_editor_command
