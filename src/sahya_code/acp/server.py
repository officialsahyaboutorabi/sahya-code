...
from sahya_code.acp.kaos import ACPKaos
from sahya_code.acp.mcp import acp_mcp_servers_to_mcp_config
from sahya_code.acp.session import ACPSession
from sahya_code.acp.tools import replace_tools
from sahya_code.acp.types import ACPContentBlock, MCPServer
from sahya_code.acp.version import ACPVersionSpec, negotiate_version
from sahya_code.app import SahyaCode
from sahya_code.auth.oauth import KIMI_CODE_OAUTH_KEY, load_tokens
from sahya_code.config import LLMModel, OAuthRef, load_config, save_config
from sahya_code.constant import NAME, VERSION
from sahya_code.llm import create_llm, derive_model_capabilities
...
class ACPServer:
    ...
    async def new_session(
        ...
        cli_instance = await SahyaCode.create(
            session,
