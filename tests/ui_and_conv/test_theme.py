...
from sahya_code.config import Config, get_default_config
...
from sahya_code.ui.shell import slash as shell_slash
from sahya_code.ui.theme import (
    get_active_theme,
    get_diff_colors,
...
def test_theme_command_registered_in_both_registries():
    from sahya_code.ui.shell.slash import registry, shell_mode_registry
...
async def test_shell_startup_initializes_theme_from_config(
    ...
    from sahya_code.ui import theme as theme_mod
    from sahya_code.ui.shell import Shell as RealShell
