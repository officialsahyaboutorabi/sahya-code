...
from sahya_code.tools.display import (
...
from sahya_code.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `sahya_code.soul.approval.Request`, but
