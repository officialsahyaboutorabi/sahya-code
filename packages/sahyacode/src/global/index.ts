...
export namespace Global {
  export const Path = {
    // Allow override via SAHYACODE_TEST_HOME for test isolation
    get home() {
      return process.env.SAHYACODE_TEST_HOME || os.homedir()
    },
    data,
...
// Initialize directories lazily to avoid top-level await
