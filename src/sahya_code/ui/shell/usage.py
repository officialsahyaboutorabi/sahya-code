...
from sahya_code.auth.platforms import get_platform_by_id, parse_managed_provider_key
from sahya_code.config import LLMModel
from sahya_code.soul.sahyasoul import SahyaSoul
from sahya_code.ui.shell.console import console
from sahya_code.ui.shell.slash import registry
from sahya_code.utils.aiohttp import new_client_session
from sahya_code.utils.datetime import format_duration
...
async def usage(app: Shell, args: str):
    ...
    assert isinstance(app.soul, SahyaSoul)
