...
Practical reference for the current tool-migration state in `packages/sahyacode`.
...
Tool tests should use the existing Effect helpers in `packages/sahyacode/test/lib/effect.ts`:
