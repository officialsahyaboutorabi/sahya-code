...
from sahya_code.wire.types import ApprovalRequest, StatusUpdate, SteerInput, TextPart
...
def _make_two_question_request():
    ...
    from sahya_code.wire.types import QuestionItem, QuestionOption
    from sahya_code.wire.types import QuestionRequest as QR
