...
from sahya_code.config import LLMModel, get_config_file, load_config, save_config
from sahya_code.llm import ProviderType, derive_model_capabilities
...
def _get_runner(req: Request) -> SahyaCodeRunner:
    """Get SahyaCodeRunner from FastAPI app state."""
...
async def update_global_config(
    ...
    runner: SahyaCodeRunner = Depends(_get_runner),
...
async def update_config_toml(
    ...
    from sahya_code.config import load_config_from_string
