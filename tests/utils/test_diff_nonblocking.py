...
from sahya_code.utils.diff import (
    _HUGE_FILE_THRESHOLD,
    _build_diff_blocks_sync,
    build_diff_blocks,
)
from sahya_code.wire.types import DiffDisplayBlock
...
def test_summary_panel_renders_modification() -> None:
    ...
    from sahya_code.utils.rich.diff_render import render_diff_summary_panel
...
def test_summary_panel_renders_new_file() -> None:
    ...
    from sahya_code.utils.rich.diff_render import _summary_description
...
def test_summary_preview_returns_renderables() -> None:
    ...
    from sahya_code.utils.rich.diff_render import render_diff_summary_preview
