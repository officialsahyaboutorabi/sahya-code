...
from sahya_code.background import TaskView, is_terminal_status
from sahya_code.soul.sahyasoul import SahyaSoul
from sahya_code.ui.shell.console import console
from sahya_code.utils.datetime import format_duration, format_relative_time
...
class TaskBrowserApp:
    def __init__(self, soul: SahyaSoul):
...
def _task_browser_style() -> Style:
    from sahya_code.ui.theme import get_task_browser_style
