...
from sahya_code.background import BackgroundTaskManager
from sahya_code.config import Config, MoonshotSearchConfig, get_default_config
from sahya_code.llm import ALL_MODEL_CAPABILITIES, LLM
from sahya_code.metadata import WorkDirMeta
from sahya_code.notifications import NotificationManager
from sahya_code.session import Session
from sahya_code.session_state import SessionState
from sahya_code.soul.agent import BuiltinSystemPromptArgs, LaborMarket, Runtime
from sahya_code.soul.approval import Approval
from sahya_code.soul.denwarenji import DenwaRenji
from sahya_code.soul.toolset import KimiToolset
from sahya_code.subagents import AgentTypeDefinition, ToolPolicy
from sahya_code.tools.agent import Agent as AgentTool
from sahya_code.tools.background import (
    TaskList,
    TaskOutput,
    TaskStop,
)
from sahya_code.tools.dmail import SendDMail
from sahya_code.tools.file.glob import Glob
from sahya_code.tools.file.grep_local import Grep
from sahya_code.tools.file.read import ReadFile
from sahya_code.tools.file.read_media import ReadMediaFile
from sahya_code.tools.file.replace import StrReplaceFile
from sahya_code.tools.file.write import WriteFile
from sahya_code.tools.shell import Shell
from sahya_code.tools.think import Think
from sahya_code.tools.todo import SetTodoList
from sahya_code.tools.web.fetch import FetchURL
from sahya_code.tools.web.search import SearchWeb
from sahya_code.utils.environment import Environment
...
def tool_call_context(tool_name: str) -> Generator[None]:
    ...
    from sahya_code.soul.toolset import current_tool_call
    from sahya_code.wire.types import ToolCall
