...
from sahya_code.tools.shell import Params as ShellParams
from sahya_code.tools.shell import Shell
from sahya_code.tools.utils import ToolResultBuilder
from sahya_code.wire.types import DisplayBlock
...
class Terminal(CallableTool2[ShellParams]):
    ...
    async def __call__(self, params: ShellParams) -> ToolReturnValue:
        from sahya_code.acp.session import get_current_acp_tool_call_id_or_none
