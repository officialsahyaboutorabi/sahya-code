...
from sahya_code.exception import InvalidToolError, MCPRuntimeError
from sahya_code.hooks.engine import HookEngine
from sahya_code.tools import SkipThisTool
...
class KimiToolset:
    ...
    def load_tools(self, tool_paths: list[str], dependencies: dict[type[Any], Any]) -> None:
        """
        Load tools from paths like `sahya_code.tools.shell:Shell`.
    ...
    async def load_mcp_tools(
        ...
        from sahya_code.ui.shell.prompt import toast
...
class WireExternalTool(CallableTool):
    ...
    async def __call__(self, *args: Any, **kwargs: Any) -> ToolReturnValue:
        ...
        from sahya_code.soul import get_wire_or_none
