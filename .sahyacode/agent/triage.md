...
Use for core server issues in `packages/sahyacode/`, excluding `packages/sahyacode/src/cli/cmd/tui/`.
...
TUI (`packages/sahyacode/src/cli/cmd/tui/...`):
...
Core (`packages/sahyacode/...`, excluding TUI subtree):
