...
class LazySubcommandGroup(typer.core.TyperGroup):
    ...
    lazy_subcommands: dict[str, tuple[str, str, str]] = {
        "info": ("sahya_code.cli.info", "cli", "Show version and protocol information."),
        "export": ("sahya_code.cli.export", "cli", "Export session data."),
        "mcp": ("sahya_code.cli.mcp", "cli", "Manage MCP server configurations."),
        "plugin": ("sahya_code.cli.plugin", "cli", "Manage plugins."),
        "vis": ("sahya_code.cli.vis", "cli", "Run Sahya Agent Tracing Visualizer."),
        "web": ("sahya_code.cli.web", "cli", "Run Sahya Code web interface."),
    }
